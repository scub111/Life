        ...
        static void Main()
        {
            ...
            else
            {
                ...
                foreach (Process process in Process.GetProcessesByName(current.ProcessName))
                {
                    ...
                    {
                        MainForm runningForm = (MainForm)Control.FromHandle(process.MainWindowHandle);
                        if (runningForm != null)
                            runningForm.Show();
                        ...
                        //PostMessage((int)process.MainWindowHandle, WM_USER, 11, 22);
                        SendMessage(0xFFFF, WM_USER, 11, 22);
